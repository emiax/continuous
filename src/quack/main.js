define(function(require) {
    ...
    console.log("loaded quack");


    function getClassFunction(c) {
        return function() {
            return c;
        }
    }
    ...
    /**
     * TODO: THIS BREAKS IF IT IS A PARENT WHO IMPLEMENTS THE INTERFACE!
     */
    function implementsInterfaceFunction(interfaces) {
        return function(i) {
...
//            console.error("declaring own constructor");
            c = function () {
                methods.constructor.apply(this, arguments);
                this.getClass = getClassFunction(c);
                this.implementsInterface = implementsInterfaceFunction(interfaces);
            }
    ...
    return {
        ...
        createInterface: function () {
            ...
            var abstractMethods = function () { throw "Cannot instanciate interface." };
