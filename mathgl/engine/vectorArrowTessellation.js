define(function (require) {
    ...
    return exports.VectorArrowTessellation = q.createClass({
        /**
         * Constructor
         */
        ...
        tessellate: function () {
            ...
            var triangleData = this._triangleData = new UInt16Array(nTriangles);
            ...
            for (theta = thetaMin; theta < thetaMax; theta += thetaStep) {
                ...
                if (i > 2) {
                    ...
                    triangleData[j++] = verticesPerRing;
                    triangleData[j++] = verticesPerRing + i - 1;
                    triangleData[j++] = verticesPerRing + i;
                }
                ...
                var i1 = (i + 1) % verticesPerRing + verticesPerRing;
                ...
                // Advance one vertex (three elements)
                i+=3;
            }
